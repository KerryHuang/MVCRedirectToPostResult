...
namespace MvcRedirectToPos.Helper.Results
{
    public class RedirectToPostResult : ActionResult
    {
        /// <summary>
        ...
        /// <Author>Samer Abu Rabie</Author>
        public static void RedirectToPOST(Page page, string destinationUrl, Dictionary<string, object> data)
        {
